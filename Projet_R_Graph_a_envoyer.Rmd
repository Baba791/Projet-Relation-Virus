...
write_tsv(Genre_Infect, "C:/Users/benja/Projet-Relation-Virus/results/Genre_Infect.tsv")
```
...
```{r}
path_results = "C:/Users/benja/Projet-Relation-Virus/results/"
...
write_tsv(Grp_virus, "C:/Users/benja/Projet-Relation-Virus/results/Grp_virus.tsv")
```
...
```
Comme on peut le voir à travers ce graphique, plus la couleur tend vers le foncé (noir) plus la centralité d'intermédiare pour ce noeud aura de l'importance, on constate que le noeud dont la centralité est la plus importante est le noeud noir qui relie deux composante du graphe. Ce qui est en cohérence avec la définition de betweenness, donc le script fonctionne comme prévu.
